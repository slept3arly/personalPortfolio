      ...
      <Card className="flex flex-col items-start justify-between gap-5 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed text-gray-400">
            A one-page overview of my skills, projects, and experience. This is a placeholder PDF for now —
            replace it anytime at <span className="font-mono text-gray-300">/public/resume.pdf</span>.
          </p>
        </div>
