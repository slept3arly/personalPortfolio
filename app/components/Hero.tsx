    ...
    <section className="py-10 sm:py-14">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h1 className="mt-6 text-balance text-4xl font-semibold tracking-tight text-white sm:text-5xl">
          Vinayak Nautiyal 24BCE2195
        </h1>
        <p className="mt-4 text-pretty text-base leading-relaxed text-gray-400 sm:text-lg">
          I build modern, performance-focused web apps with clean UI, practical UX, and
          production-grade structure. I enjoy shipping polished experiences end-to-end — from
          component design to integration and deployment.
        </p>
